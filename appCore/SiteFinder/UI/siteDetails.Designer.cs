...
namespace appCore.SiteFinder.UI
{
	partial class siteDetails
	{
		...
		private appCore.UI.AMTTextBox amtTextBox5;
		...
		private void InitializeComponent()
		{
			...
			this.amtTextBox5 = new appCore.UI.AMTTextBox();
			...
			this.button45.Location = new System.Drawing.Point(429, 82);
			...
			this.checkBox1.Location = new System.Drawing.Point(220, 255);
			...
			this.checkBox1.CheckedChanged += new System.EventHandler(this.dataGridViewFilter_Changed);
			// 
			// checkBox2
			// 
			...
			this.checkBox2.Location = new System.Drawing.Point(258, 255);
			...
			this.checkBox2.CheckedChanged += new System.EventHandler(this.dataGridViewFilter_Changed);
			// 
			// checkBox3
			// 
			...
			this.checkBox3.Location = new System.Drawing.Point(296, 255);
			...
			this.checkBox3.CheckedChanged += new System.EventHandler(this.dataGridViewFilter_Changed);
			// 
			// label3
			// 
			...
			// textBox9
			// 
			this.textBox9.Location = new System.Drawing.Point(222, 30);
			...
			this.checkBox6.Text = "TF";
			this.checkBox6.TextAlign = System.Drawing.ContentAlignment.TopCenter;
			this.checkBox6.UseVisualStyleBackColor = true;
			this.checkBox6.CheckedChanged += new System.EventHandler(this.dataGridViewFilter_Changed);
			// 
			// checkBox7
			// 
			...
			this.label17.Text = "Onward Sites";
			this.label17.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// amtTextBox5
			// 
			this.amtTextBox5.Location = new System.Drawing.Point(254, 55);
			this.amtTextBox5.Name = "amtTextBox5";
			this.amtTextBox5.ReadOnly = true;
			this.amtTextBox5.Size = new System.Drawing.Size(42, 20);
			this.amtTextBox5.TabIndex = 155;
			// 
			// button2
			// 
			...
			this.button2.Text = "View sites";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.Button2Click);
			// 
			// label19
			// 
			this.label19.Location = new System.Drawing.Point(459, 31);
			this.label19.Name = "label19";
			this.label19.Size = new System.Drawing.Size(43, 20);
			this.label19.TabIndex = 159;
			this.label19.Text = "CCT ref";
			...
			this.toggleSwitch1.EnabledChanged += new System.EventHandler(this.toggleSwitches_EnabledChanged);
			// 
			// toggleSwitch2
			// 
			...
			this.toggleSwitch2.EnabledChanged += new System.EventHandler(this.toggleSwitches_EnabledChanged);
			// 
			// label20
			// 
