...
namespace GMap.NET.WindowsForms
{
...
#endif
   {
      ...
      internal void UpdateGraphicsPath()
      {
          ...
          {
              System.Drawing.Point[] pnts = new System.Drawing.Point[LocalPoints.Count];
              for (int i = 0; i < LocalPoints.Count; i++)
              {
                  System.Drawing.Point p2 = new System.Drawing.Point((int)LocalPoints[i].X, (int)LocalPoints[i].Y);
