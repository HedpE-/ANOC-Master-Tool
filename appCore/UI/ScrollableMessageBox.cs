...
namespace appCore.UI
{
	...
	public partial class ScrollableMessageBox : Form
	{
		...
		/// <param name="title">Title label on the message box</param>
		public void Show (string text, string caption, string title, bool CharCount)
		{
			...
			if(CharCount) {
				label2.Visible = true;
				if(txtMessage.TextLength > 4000) {
					label2.Font = new Font(label2.Font, FontStyle.Bold);
					label2.ForeColor = Color.Red;
					label2.Text = "Template has over 4000 characters" + Environment.NewLine + "Current Length: " + txtMessage.TextLength.ToString();
				}
				else label2.Text = "Text Length - " + txtMessage.TextLength.ToString();
			}
			this.ShowDialog();
		}

		public void Show (string text, string caption, MessageBoxButtons buttonType, string title, bool CharCount)
		{
			txtMessage.Text = text;
			this.Text = caption;
		...
		public void ShowFromFile(string filename, string caption, MessageBoxButtons buttonType, string title)
		{
		...
		private void AddOKButton()
		{
			...
			btnOK.Location = new Point(this.Width / 2 - 35, this.Height);
			//btnOK.Location = new Point(this.Width / 2 - 35, this.Height - txtMessage.Bottom + 5);
